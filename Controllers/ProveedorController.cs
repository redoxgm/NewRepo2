...
namespace tpLabo4_usarEste_.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Nombreproovedor,descripcion")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Nombreproovedor,descripcion")] Proveedor proveedor)
        {
            if (id != proveedor.id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Proveedor'  is null.");
            }
            var proveedor = await _context.Proveedor.FindAsync(id);
            if (proveedor != null)
            {
